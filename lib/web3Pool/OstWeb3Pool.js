 ...
 * @param {object} {optional} net - object to connect with IPC.
...
Web3Pool.prototype = /** @lends Web3Pool# */ {
  ...
  getInstanceWithRetryCnt: function(retryCnt) {
    ...
    if (!web3) {
      logger.debug('Creating new instance of web3. poolIndx:', poolIndx);
      // Create a new web3 instance.
      web3 = oThis._pool[poolIndx] = new OSTWeb3(oThis.provider, oThis.net, oThis.ostWeb3Options);
    } else if (retryCnt > 0) {
      logger.debug('Choosing Existing Connection. poolIndx:', poolIndx);
